...
[在线演示](https://lessup.github.io/bookmarks-manager/) · [架构说明](docs/ARCHITECTURE.md) · [贡献说明](docs/CONTRIBUTING.md)
...
| 文件                  | 用途                   |
| --------------------- | ---------------------- |
| `docs/ARCHITECTURE.md` | 精简且准确的架构说明   |
| `docs/CONTRIBUTING.md` | 当前仓库的真实开发流程 |
| `CHANGELOG.md`        | 精简后的版本记录       |
| `openspec/`           | 变更提案、规格与归档   |
| `AGENTS.md`           | AI 助手仓库指令        |
